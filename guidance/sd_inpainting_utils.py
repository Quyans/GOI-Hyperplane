...
class StableDiffusion(nn.Module):
    ...
    def train_step(
        ...
        with torch.no_grad():
            ...
            latent_model_input = torch.cat([latent_model_input, mask_latent_t, masked_image_latents], dim=1)
        ...
        if save_guidance_path:
            with torch.no_grad():
                ...
                # save_image(pred_rgb_512[0],os.path.join("testfolder","pred_rgb_512.png"))
                # save_image(masks_512[0],os.path.join("testfolder","masks_512.png"))
                print(t)
